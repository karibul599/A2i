export default class contractManagement{
    ...
    addNewContractManagemenForIndividualConsultant (randomName, packageTitle,referenceNo){
      const x=2000;
      //Consultant Type
      cy.wait(5000)
      cy.get('[formcontrolname="consultantType"]')
        ...
        .click()
      cy.wait(x)
      cy.contains(' Individual Consultant ')
        .should('exist')
        .and('be.visible')
        .click()
      cy.wait(x)
      //Contract Holder Name
      cy.get('[placeholder="Contract Holder Name"]')
        .should('exist')
        .and('be.visible')
        .click()
      cy.wait(x)
      cy.contains(' Mohammed Naser Miah ')
        .should('exist')
        .and('be.visible')
        .click()
      //Fund Source
      ...
      cy.contains(' UNDP ')
        ...
        .click()
      //Contract Modality
      cy.get('[formcontrolname="contractModality"]')
        .should('exist')
        .and('be.visible')
        .click()
      cy.wait(x)
      cy.contains(' Individual Contract - UNDP ')
        .should('exist')
        .and('be.visible')
        .click()
      //Team
      ...
      cy.contains(' Finance ')
        ...
        .click()
      //Designation
      cy.get('[placeholder="Designation"]')
        .should('exist')
        .and('be.visible')
        .click()
      cy.wait(x)
