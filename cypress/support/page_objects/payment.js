export default class payment{
    ...
    if (paymentName===' Individual Payment '||paymentName===' Vendor Payment ') {
        ...
        //Payee Type
        //Payee
        cy.get('[placeholder="Select Non PO Vendor"]')
          .should('exist')
          .and('be.visible')
          .type(' Business Automation Ltd. ')
         cy.wait(x) 
        ...
        cy.xpath('/html/body/div[3]/div/div/div/mat-option[2]')
          .click()
        // //Quantum Supplier ID
        // cy.get('[formcontrolname="supplierId"]')
        //   .should('exist')
        //   .and('be.visible')
        //   .type('1234')
    ...
    fillupPaymentFormNoCashbook(paymentName) {
        const x=700;
        //Cashbook Type
